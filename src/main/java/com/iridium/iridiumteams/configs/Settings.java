...
public class Settings {
    ...
    public Settings(String team, String color) {
        teamJoining = new Setting(new Item(XMaterial.COBBLESTONE, 10, 1, color + team + " Type", Arrays.asList("&7Set your " + team + " joining method.", "", "" + color + "&lValue", "&7%value%")), "JoinType", "Private");
